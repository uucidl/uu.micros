...
This branch standardizes on C++11 and OpenGL 2.1 and targets
Darwin/OSX past 10.7 (Lion) and NT/Windows 7 and beyond.
...
- host system with =OpenGL 2.1= core context and 48khz stereo audio
